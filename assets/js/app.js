...
const FormValidation = (function () {
    ...
    const selectDestination = function (element) {
        ...
        destinationInput.value = destination.innerHTML;
        destination.dataset.id = destination.dataset.id;
        destination.dataset.parentid = destination.dataset.parentid;
        destination.dataset.type = destination.dataset.type;
        destinationLocations.classList.remove('opened');
        swapLocationIcon.style.display = 'flex';
    }
